...
const PlaceMent = () => {
  ...
  const eduValidateForm = () => {
    ...
    if (eduFormData.branchAddresses) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box
          sx={{ display: "flex", gap: { xs: 1.5, md: 3 }, flexWrap: "wrap" }}
        >
      ...
      <Grid container spacing={{ xs: 2, md: 3 }} sx={{ mb: { xs: 3, md: 4 } }}>
        <Grid item xs={12} sm={6} md={3}>
          <Paper
            elevation={0}
            sx={{ p: { xs: 2, md: 3 }, borderRadius: 4, position: "relative" }}
          >
            <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
              ...
              <InfoOutlinedIcon
                sx={{ fontSize: 16, ml: "auto", color: "gray" }}
              />
            </Box>
        ...
        <Grid item xs={12} md={3}>
          <Paper elevation={0} sx={{ p: 3, borderRadius: 4, height: "78%" }}>
            ...
            <Chip
              ...
              label="0%"
              size="small"
              sx={{ bgcolor: "#f1f8f4", color: EDU_COLORS.accent }}
            />
        ...
        <Grid item xs={12} md={3}>
          <Paper elevation={0} sx={{ p: 3, borderRadius: 4, height: "78%" }}>
            ...
            <Typography variant="h3" sx={{ fontWeight: "bold", my: 1 }}>
              7.2 <small style={{ fontSize: "1rem" }}>LPA</small>
            </Typography>
            <Typography variant="caption" color="textSecondary">
        ...
        <CardContent sx={{ p: { xs: 2, md: 3 } }}>
          ...
          <EduFormRow>
            ...
            <TextField
              ...
              helperText={
                eduErrors.secondarySector ||
                "Optional – select additional focus area"
              }
            >
          ...
          >
            <Button
              ...
              sx={{
                backgroundColor: EDU_COLORS.primary,
                "&:hover": { backgroundColor: "rgb(3, 36, 4)" },
                px: { xs: 2, md: 4 },
